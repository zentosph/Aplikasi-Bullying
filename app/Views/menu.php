                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="<?=base_url('assets/images/website/'.$setting->icon_menu)?>" alt="homepage" class="dark-logo" width="150px" height="120px"/>
                                <!-- Light Logo icon -->
                                <img src="<?=base_url('assets/images/website/'.$setting->icon_menu)?>" alt="homepage" class="light-logo" width="150px" height="150px"/>
                            </b>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="<?=base_url('assets/images/website/'.$user->foto)?>" class="rounded-circle"
                                    width="40">
                                <span class="ml-2 d-none d-lg-inline-block"><span
                                        class="text-dark"><?=session()->get('nama')?> | <?=$user->kelas ?? '' ?></span> <i data-feather="chevron-down"
                                        class="svg-icon"></i></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item" href="<?=base_url('home/profile/'.$user->id_user)?>"><i data-feather="user"
                                ...
                                <a class="dropdown-item" href="<?=base_url('home/logout')?>"><i data-feather="power"
                                    ...
                                    Logout</a>
                                <div class="dropdown-divider"></div>
                                <div class="pl-4 p-3"><a href="<?=base_url('home/profile/'.$user->id_user)?>" class="btn btn-sm btn-info">View
                                        Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php if ($menu->kasus == 1) { ?>
                        ...
                        <li class="nav-small-cap"><span class="hide-menu">Kasus</span></li>
                    
                        <li class="sidebar-item"> <a class="sidebar-link" href="<?=base_url('home/t_kasus')?>"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Form Kasus
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="<?=base_url('home/kasus')?>"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                    ...
                    <?php if ($menu->data == 1) { ?>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="<?=base_url('home/dkasus')?>" class="sidebar-link"><span
                                            class="hide-menu"> Kasus
                                        </span></a>
                                </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="<?=base_url('home/skasus')?>" class="sidebar-link"><span
                                            class="hide-menu"> Kasus
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="<?=base_url('home/suser')?>" class="sidebar-link"><span
                                            class="hide-menu"> User
                                        </span></a>
                                </li>
                            </ul>
