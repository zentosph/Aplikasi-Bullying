...
function generatePDF() {
    ...
    var url = '<?= base_url('home/kasus_pdf') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
...
function generateEXCEL() {
    ...
    // Build the URL for the PDF
    var url = '<?= base_url('home/kasus_excel') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
...
function generateWINDOWS() {
    ...
    // Build the URL for the PDF
    var url = '<?= base_url('home/kasus_windows') ?>' + '?start_date=' + encodeURIComponent(startDate) + '&end_date=' + encodeURIComponent(endDate);
