...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="file" id="image" name="image" accept="image/*" onchange="previewImage(event)" value="<?= $users->foto ?>">
            <div id="imagePreview">
            <img id="previewImg" src="<?= base_url('assets/images/users/' . $users->foto) ?>" alt="Preview Image" style="<?= $users->foto ? '' : 'display: none;' ?>" width="100px">
            </div>
        </div>
            <div class="form-group">
