                    ...
                    <div class="col-sm-12 col-md-6 col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="back">
                                <a href="<?=base_url('home/kasus')?>">
                                <button class="btn btn-primary">back</button>
                                </a>
                                </div>
                                <?php if (session()->get('level') == 1 && $satu->status == "Pending") { ?>
                                <div class="selesai">
                                <a href="<?=base_url('home/statusproses/'.$satu->id_kasus)?>">
                                <button class="btn btn-primary">Proses</button>
                                </a>
                                </div>
                                <?php } ?>

                                <?php if (session()->get('level') == 1 && $satu->status == "Proses") { ?>
                                <div class="selesai">
                                <a href="<?=base_url('home/statuspks/'.$satu->id_kasus)?>">
                                <button class="btn btn-primary">Tindaklanjut</button>
                                <a href="<?=base_url('home/statusselesai/'.$satu->id_kasus)?>">
                                ...
                                <?php if (session()->get('level') == 1 && $satu->status == "Proses ke Kepala Sekolah") { ?>
                                <div class="selesai">
                                <a href="<?=base_url('home/statusselesai/'.$satu->id_kasus)?>">
