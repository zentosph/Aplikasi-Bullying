...
<body>
    ...
    <div class="auth-box row">
        <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(<?=base_url('assets/images/website/'.$setting->login_image)?>);">
        </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="<?=base_url('assets/images/website/'.$setting->login_icon)?>" alt="wrapkit">
                        </div>
