                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-4" method="post" action="<?= base_url('home/aksi_esetting') ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img id="tabIconPreview" src="<?= base_url('assets/images/website/' . $setting->icon_website) ?>" alt="Tab Icon" width="100" height="100">

                                    <h6 class="card-title">Menu Icon</h6>
                                    <input type="file" name="m_icon" onchange="previewImage(this, 'menuIconPreview')">
                                    <br>
                                    <img id="menuIconPreview" src="<?= base_url('assets/images/website/' . $setting->icon_menu) ?>" alt="Menu Icon" width="100" height="100">

                                    <h6 class="card-title">Login Icon</h6>
                                    <input type="file" name="l_icon" onchange="previewImage(this, 'loginIconPreview')">
                                    <br>
                                    <img id="loginIconPreview" src="<?= base_url('assets/images/website/' . $setting->login_icon) ?>" alt="Login Icon" width="100" height="100">

                                    <h6 class="card-title">Login Image</h6>
                                    <input type="file" name="l_image" onchange="previewImage(this, 'loginImagePreview')">
                                    <br>
                                    <img id="loginImagePreview" src="<?= base_url('assets/images/website/' . $setting->login_image) ?>" alt="Login Image" width="100" height="100">
                                </div>
