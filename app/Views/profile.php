...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div id="imagePreview">
            <img id="previewImg" src="<?= base_url('assets/images/users/' . $user->foto) ?>" alt="Preview Image" style="<?= $user->foto ? '' : 'display: none;' ?>" width="100px">
            </div>
        </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="nama" value="<?= $user->nama ?>" required>
            </div>
            <div class="form-group">
